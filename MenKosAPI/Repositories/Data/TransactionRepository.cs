...
namespace MenKosAPI.Repositories.Data
{
    public class TransactionRepository
    {
        ...
        public async Task SavePaymentNewTransaction(NewTransactionVM newTransaction)
        {
            ...
            var uploads = Path.Combine(@"D:\MetroData\TestVS\Kosan\ENDGAME\ManajemenKos-endgame\FINAL\MenKosClient\wwwroot", "users", "payment", newTransaction.NIK.ToString());
        ...
        public async Task SavePaymentExtendTransaction (ExtendTransactionVM extendTransaction)
        {
            ...
            var uploads = Path.Combine(@"D:\MetroData\TestVS\Kosan\ENDGAME\ManajemenKos-endgame\FINAL\MenKosClient\wwwroot", "users", "extend", extendTransaction.RoomId.ToString());
